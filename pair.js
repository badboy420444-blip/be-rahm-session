...
async function uploadCredsToMega(credsPath) {
    try {
        const storage = await new Storage({
            email: 'amirjan2097@gmail.com', // Your Mega A/c Email Here
            password: 'Kaihan420@' // Your Mega A/c Password Here
        }).ready;
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'BE_RAHM~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
🔗 *Join Our Support Group:* 👉 [Click Here to Join](https://chat.whatsapp.com/Ch3RYPp0fbkDqN3SbXLb7a) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [𓍯‌𝐁𝐞↷𝐑𝐚𝐡𝐦🫩❗ GitHub Repo](https://github.com/badboy420444-blip)  
